...
var options = {
    ...
    templates: {
        ...
        plainVideoLoadIcon: '<span class="nk-video-icon"><span class="loading-icon"></span></span>',

        audioPlainButton: '<div class="nk-audio-plain-play-pause">\n                <span class="nk-audio-plain-play">\n                    <span class="ion-play ml-3"></span>\n                </span>\n                <span class="nk-audio-plain-pause">\n                    <span class="ion-pause"></span>\n                </span>\n            </div>',

        instagram: '<div class="col-4">\n                <a href="{{link}}" target="_blank">\n                    <img src="{{image}}" alt="{{caption}}" class="img-stretch">\n                </a>\n            </div>',
...
function initNavbar() {
    ...
    function correctDropdown($item) {
        if ($item.parent().is('.nk-nav')) {
            ...
            var $parent = $item.closest('.navbar');
...
function initNavbarSide() {
    var self = this;
    var $overlay = (0, _utility.$)('<div class="navbar-overlay">').appendTo(_utility.$body);
...
function initPluginFlickity() {
    ...
    function addDefaultArrows($carousel) {
        (0, _utility.$)('<div class="flickity-arrow flickity-arrow-prev"><span class="ion-ios-arrow-back"></span></div>').on('click', function () {
            $carousel.flickity('previous');
        }).appendTo($carousel);

        (0, _utility.$)('<div class="flickity-arrow flickity-arrow-next"><span class="ion-ios-arrow-forward"></span></div>').on('click', function () {
